...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("PurchaseItemSrvObjectPageObjectPage journey");

        opaTest("Navigate to PurchaseItemSrvObjectPageObjectPage", function (Given, When, Then) {
            Given.iStartMyApp();
            ...
            Then.onThePurchaseItemSrvObjectPage.iSeeThisPage();
        });
